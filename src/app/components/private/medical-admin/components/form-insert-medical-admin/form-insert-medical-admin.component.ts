...
@Component({
  selector: 'app-form-insert-medical-admin',
  standalone: true,
  ...
  templateUrl: './form-insert-medical-admin.component.html',
  styleUrl: './form-insert-medical-admin.component.scss'
})
export class FormInsertMedicalAdminComponent {
    ...
    if (this.formGroup.valid) {
      ...
      this.apiService
        .postService({
          ...
          url: `${UriConstants.POST_MEDICAL_ADMIN}`,
          data: AdminData,
        })
        .subscribe({
          next: (response) => {
