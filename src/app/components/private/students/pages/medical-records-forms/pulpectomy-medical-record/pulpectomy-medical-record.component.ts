...
@Component({
  selector: 'app-pulpectomy-medical-record',
  standalone: true,
  imports: [
    MatInputModule,
    TabFormComponent,
  ...
  templateUrl: './pulpectomy-medical-record.component.html',
  styleUrl: './pulpectomy-medical-record.component.scss'
})
export class PulpectomyMedicalRecordComponent extends MedicalRecordBaseComponent {
  constructor() {
    super();
  }

  protected getMedicalRecordType(): EMedicalRecords {
    return EMedicalRecords.PULPECTOMIA;
  }
}
