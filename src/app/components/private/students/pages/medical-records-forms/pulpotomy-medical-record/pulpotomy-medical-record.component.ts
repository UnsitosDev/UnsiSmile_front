...
@Component({
  selector: 'app-pulpotomy-medical-record',
  standalone: true,
  imports: [
    MatInputModule,
    TabFormComponent,
  ...
  templateUrl: './pulpotomy-medical-record.component.html',
  styleUrl: './pulpotomy-medical-record.component.scss'
})
export class PulpotomyMedicalRecordComponent extends MedicalRecordBaseComponent {
  constructor() {
    super();
  }

  protected getMedicalRecordType(): EMedicalRecords {
    return EMedicalRecords.PULPOTOMIA;
  }
}