...
@Component({
  selector: 'app-form-update-medical-admin',
  standalone: true,
  imports: [ MatFormFieldModule,
    ...
    MatCardModule,
    LoadingComponent],
  templateUrl: './form-update-medical-admin.component.html',
  styleUrl: './form-update-medical-admin.component.scss'
})
export class FormUpdateMedicalAdminComponent {
 private toastr = inject(ToastrService);
  ...
  private loadAdminData() {
    this.apiService.getService({
      ...
      url: `${UriConstants.GET_MEDICAL_ADMIN_BY_EMPLOYEENUMBER}${this.employeeNumber}`,
      data: {},
    }).subscribe({
      next: (response) => {
  ...
  onBack() {
    this.router.navigate(['/admin/medical-admin']);
  }
  ...
  onSubmit() {
    if (this.formGroup.valid) {
      ...
      this.apiService.patchService({
        ...
        url: `${UriConstants.PATCH_MEDICAL_ADMIN_BY_EMPLOYEENUMBER}${formValues.employeeNumber}`,
        data: AdminData,
      }).subscribe({
        next: () => {
